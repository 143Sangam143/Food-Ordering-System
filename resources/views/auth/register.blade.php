<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mt-4">
                <x-label for="user_type" value="{{ __('Usertype') }}" />
                <div class="flex max-2xs:flex-col justify-between">
                    <div class="flex items-center">
                        <x-input id="user_type" class="block mr-1" type="radio" name="usertype" value="0" checked required />User
                    </div>
                    <div class="flex items-center">
                        <x-input id="user_type" class="block mr-1" type="radio" name="usertype" value="2" required />Restaurant
                    </div>
                </div>
            </div>
